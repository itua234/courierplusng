        ...
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-8 col-md-10 col-sm-12">
                <div class="card shadow p-4">
                    ...
                    <form id="signin" action="{{route('signin')}}" method="POST">
                        @csrf
                        <div class="row justify-content-center">
                        ...
                        <h6 style="font-size:14px;" class="mt-2 text-center">Already have an account? <a href="#" class="custom-text-secondary">Sign up</a></h6>
                    </form>
                </div>
            </div>
        </div>
